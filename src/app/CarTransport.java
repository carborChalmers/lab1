...
public class CarTransport extends Vehicle implements Transporter{
    ...
    public void load(Transportable transportable){
        ...
        if((transportable instanceof Vehicle vehicle)){
    ...
    public Transportable unload(){
        ...
        Vehicle vehicle=loadedVehicles.pop();
        ((Transportable)vehicle).setBeingTransported(false);
        return (Transportable) vehicle;
    }
